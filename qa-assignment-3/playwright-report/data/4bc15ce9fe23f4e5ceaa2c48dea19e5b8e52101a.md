...
- Name: 01_homepage.spec.ts >> Homepage >> TC-HP-04: Top navigation menu has category links
- Location: tests/specs/01_homepage.spec.ts:27:7
...
Locator: locator('.ps-mainmenu__tree-link').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.ps-mainmenu__tree-link').first()
