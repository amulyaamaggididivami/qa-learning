...
- Name: 01_homepage.spec.ts >> Homepage >> TC-HP-06: Product cards show name and price
- Location: tests/specs/01_homepage.spec.ts:38:7
...
Locator: locator('.product-miniature').first().locator('.product-title, h3, .product-miniature__title')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.product-miniature').first().locator('.product-title, h3, .product-miniature__title')
